              ...
              {openModal === "privacy" && (
                <>
                  ...
                  <p className="text-muted-foreground">
                    ...
                    Phone:{" "}
                    <a className="text-primary underline underline-offset-2" href="tel:+97143357477">
                      +971 4 335 7477
                    </a>
                  </p>
                </>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <a href="tel:+97143357477" className="text-muted-foreground hover:text-primary transition-colors">
                    +971 4 335 7477
                  </a>
                </div>
